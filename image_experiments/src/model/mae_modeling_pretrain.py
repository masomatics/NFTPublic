...
from src.model.mae_modeling_finetune import Block, _cfg, PatchEmbed, get_sinusoid_encoding_table, PatchEmbedDualNorm
...
class PretrainVisionTransformerEncoder(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=0, embed_dim=768, depth=12,
                 ...
                 use_learnable_pos_emb=False, dualnorm=False):
        super().__init__()
        self.num_classes = num_classes
        self.num_features = self.embed_dim = embed_dim  # num_features for consistency with other models
        
        patchemb_class = PatchEmbedDualNorm if dualnorm else PatchEmbed
        self.patch_embed = patchemb_class(
